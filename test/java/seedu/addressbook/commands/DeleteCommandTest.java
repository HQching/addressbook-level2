...
public class DeleteCommandTest {
    ...
    public void setUp() throws Exception {
        ...
        Person janeDoe = new Person(new Name("Jane Doe"), new Phone("91234567", false),
                new Email("jane@doe.com", false), new Address("33G, Ohm Road, #02-02, 234545", false), new UniqueTagList());
        Person samDoe = new Person(new Name("Sam Doe"), new Phone("63345566", false),
                new Email("sam@doe.com", false), new Address("55G, Abc Road, #03-03, 346565", false), new UniqueTagList());
        Person davidGrant = new Person(new Name("David Grant"), new Phone("61121122", false),
                new Email("david@grant.com", false), new Address("44H, Define Road, #04-04 456575", false),
                new UniqueTagList());
    ...
    public void execute_targetPersonNotInAddressBook_returnsPersonNotFoundMessage()
        ...
        Person notInAddressBookPerson = new Person(new Name("Not In Book"), new Phone("63331444", false),
                new Email("notin@book.com", false), new Address("156D, Grant Road, #05-05 546792", false), new UniqueTagList());
