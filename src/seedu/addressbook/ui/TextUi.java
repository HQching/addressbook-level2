...
/**
 * Text UI of the application. Takes in inputs from user and shows outputs to
 * users.
 */
public class TextUi {
     ...
     * empty, pure whitespace, and comment lines. Echos the command back to the user.
     * 
    ...
    public void showResultToUser(CommandResult result) {
        ...
        if (resultPersons.isPresent()) {
            out.print(Formatter.showPersonListView(resultPersons.get()));
        }
