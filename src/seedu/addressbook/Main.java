...
public class Main {
    ...
    private CommandResult executeCommand(Command command) {
        try {
            checkIfFileExists(storage.getFile());
    ...
    /**
     * Checks if the storage file exists. Throws an exception if file has been deleted.
     */
    private void checkIfFileExists(File file) throws FileNotFoundException {
        if (!file.exists()) {
            throw new FileNotFoundException(Messages.MESSAGE_STORAGE_FILE_MISSING);
        }
    }
